...
var SettingsPage = (function () {
    ...
    SettingsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-settings',template:/*ion-inline-start:"/Users/robbiethomas/MyAngularPrj/src/pages/settings/settings.html"*/'<ion-header>\n  \n    <ion-navbar>\n      <ion-title>Add New City</ion-title>\n    </ion-navbar>\n  \n  </ion-header>\n  \n  \n  <ion-content>\n    <form (ngSubmit)="saveForm()">\n      <ion-item>\n        <ion-label>City : </ion-label>\n        <ion-input [(ngModel)]="city" name="city" type="text"></ion-input>\n      </ion-item>\n      <ion-item>\n        <ion-label>State : </ion-label>\n        <ion-input [(ngModel)]="state" name="state" type="text"></ion-input>\n      </ion-item>\n      <button ion-button type="Submit" block>Add City</button>\n    </form>\n  </ion-content>'/*ion-inline-end:"/Users/robbiethomas/MyAngularPrj/src/pages/settings/settings.html"*/,
        }),
...
var TabsPage = (function () {
    ...
    TabsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/Users/robbiethomas/MyAngularPrj/src/pages/tabs/tabs.html"*/'<ion-tabs>\n  <ion-tab [root]="tab1Root" tabTitle="Home" tabIcon="home"></ion-tab>\n  <ion-tab [root]="tab2Root" tabTitle="About" tabIcon="information-circle"></ion-tab>\n</ion-tabs>\n'/*ion-inline-end:"/Users/robbiethomas/MyAngularPrj/src/pages/tabs/tabs.html"*/
        }),
...
var AboutPage = (function () {
    ...
    AboutPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-about',template:/*ion-inline-start:"/Users/robbiethomas/MyAngularPrj/src/pages/about/about.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      About\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n\n</ion-content>\n'/*ion-inline-end:"/Users/robbiethomas/MyAngularPrj/src/pages/about/about.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* NavController */]])
    ], AboutPage);
    return AboutPage;
...
var HomePage = (function () {
    ...
    HomePage.prototype.ionViewDidLoad = function () {
        ...
        var currentCityInfo = [currentLocation];
        this.cityListObj = currentCityInfo;
        this.storage.get('location').then(function (val) {
            if (val != null) {
                _this.storedLocations = JSON.parse(val);
                console.log("storedLocations", _this.storedLocations);
                _this.storedLocations.forEach(function (item) {
    ...
    HomePage.prototype.addNewItem = function () {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_3__settings_settings__["a" /* SettingsPage */]);
    };
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"/Users/robbiethomas/MyAngularPrj/src/pages/home/home.html"*/'<ion-header>\n\n  <ion-navbar>\n    <ion-title>My Favourite Cities</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n  <button ion-button color="primary" block (click)="addNewItem()">Add New City</button>\n  <ion-list *ngFor="let item of cityListObj" (click)="itemSelected(item)">\n    <ion-item>\n      <h2>{{ item.city }}</h2>\n    </ion-item>\n  </ion-list>\n</ion-content>'/*ion-inline-end:"/Users/robbiethomas/MyAngularPrj/src/pages/home/home.html"*/
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__pages_settings_settings__ = __webpack_require__(101);
...
var MyApp = (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/Users/robbiethomas/MyAngularPrj/src/app/app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"/Users/robbiethomas/MyAngularPrj/src/app/app.html"*/
        }),
